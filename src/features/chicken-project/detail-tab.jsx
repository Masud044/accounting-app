  ...
  const columns = [
    {
      accessorKey: "QTY",
      header: () => (
        <div className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Quantity</div>
      ),
      cell: ({ row }) => (
    ...
    },
    {
      accessorKey: "FROM_DATE",
      header: () => (
        <div className="text-xs font-semibold text-gray-500 uppercase tracking-wider">From Date</div>
      ),
      cell: ({ row }) => (
        <div className="text-sm text-gray-700">{formatDate(row.getValue("FROM_DATE"))}</div>
      ),
    },
    {
      accessorKey: "TO_DATE",
      header: () => (
        <div className="text-xs font-semibold text-gray-500 uppercase tracking-wider">To Date</div>
      ),
      cell: ({ row }) => (
        <div className="text-sm text-gray-700">{formatDate(row.getValue("TO_DATE"))}</div>
      ),
    },
    {
      accessorKey: "DESCRIPTION",
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-end">
        ...
        >
          <IconCircleDashedPlus className="mr-1.5 h-4 w-4" /> Add Detail
        </Button>
      </div>
              ...
              <TableRow>
                <TableCell colSpan={columns.length} className="h-32 text-center">
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <p className="text-sm font-medium text-gray-500">No details added yet</p>
                    <p className="text-xs text-gray-400">Add a quantity record to get started</p>
                  </div>
                </TableCell>
              </TableRow>
            )}
