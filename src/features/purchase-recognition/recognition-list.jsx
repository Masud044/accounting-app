...
// import { toast } from "react-toastify";
// import { Link, useNavigate } from "react-router-dom";
// import { Plus, Pencil, Trash2, Package, Wallet, Lock, Send, Clock, CheckCircle2, ClipboardList } from "lucide-react";
// import axios from "axios";
...
//             </div>
//             <div>
//               <h2 className="text-sm font-bold text-gray-900">Purchase Recognition Forms</h2>
//               <p className="text-xs text-gray-400">{forms.length} total — one row per form</p>
//             </div>
//           </div>
//           <div className="flex items-center gap-2">
...
//                 <tr>
//                   <th className="px-3 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wide">Form ID</th>
//                   <th className="px-3 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wide">PO Number</th>
//                   <th className="px-3 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wide">Vendor</th>
//                   <th className="px-3 py-3 text-center text-xs font-semibold text-gray-500 uppercase tracking-wide">Items</th>
...
//                   return (
//                     <tr key={form.FORM_ID} className="hover:bg-gray-50/70 transition-colors">
//                       <td className="px-3 py-3 text-sm font-medium text-gray-800">{form.FORM_ID}</td>
//                       <td className="px-3 py-3 text-sm text-gray-500">{form.PO_NUMBER}</td>
//                       <td className="px-3 py-3 text-sm text-gray-700">{form.VENDOR_NAME}</td>
//                       <td className="px-3 py-3 text-center text-sm text-gray-500">{form.ITEM_COUNT} items</td>
//                       <td className="px-3 py-3 text-right text-sm font-semibold text-gray-800 tabular-nums">
//                         {fmtMoney(form.TOTAL_AMOUNT)}
//                       </td>

//                       <td className="px-3 py-3">
//                         {Number(form.STATUS) === 1 && (
//                           <Button
//                             size="sm" variant="outline" className="h-7 px-2 bg-white border-gray-200"
//                             disabled={sendForApprovalMutation.isPending}
//                             onClick={() => handleSendForApproval(form.FORM_ID)}
//                           >
//                             <Send className="h-3.5 w-3.5 mr-1" /> Send for Approval
      ...
      <div className="rounded-lg bg-white border border-gray-200 shadow-sm">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 px-5 py-4 border-b border-gray-100">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button onClick={() => navigate("/dashboard/purchase-recognition/new")}>
              <Plus className="h-4 w-4 mr-1" /> New Form
            </Button>
          </div>
        </div>
                      ...
                      <td className="px-3 py-3 text-right">
                        <div className="flex items-center justify-end gap-1">
                          ...
                          <Button
                            ...
                            onClick={() => navigate(`/dashboard/purchase-recognition/edit/${form.FORM_ID}`)}
                            title={isApproved ? "View (Approved — read-only)" : "Edit"}
                          >
                            <Pencil className="h-3.5 w-3.5" />
                          </Button>
