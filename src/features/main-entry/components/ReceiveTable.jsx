...
// // //     queryKey: ["voucherReview", "receive", reviewVoucher?.ID],
// // //     queryFn: async () => (await ReceiveService.search(reviewVoucher.ID)).data,
...
// // //       id: "type",
// // //       header: () => (
// // //         <div className="text-center text-xs font-semibold text-gray-500 uppercase tracking-wide">Type</div>
// // //       ),
// // //       cell: ({ row }) => (
// // //         <div className="flex justify-center">
// // //           <EntryTypeBadge type={row.original.TYPE} />
...
// // //       id: "attachment",
// // //       header: () => (
// // //         <div className="text-center text-xs font-semibold text-gray-500 uppercase tracking-wide">Files</div>
// // //       ),
// // //       cell: ({ row }) => (
// // //         <div className="flex justify-center">
// // //           <AttachmentIndicator count={row.original.DOC_COUNT} />
...
// // //                     parseFloat(reviewVoucher.CREDIT || 0)
// // //                   )}
// // //                 </div>
// // //               </div>
// // //               <div>
...
// // //                             {d.codedescription || d.description || "—"}
// // //                           </td>
...
// //   // ── Distribution rows only — payment/cash code row excluded, single
// //   //     "amount" per row regardless of whether it currently sits on the
// //   //     debit or credit side (normal vs reversed voucher). ───────────────
// //   // const distributionRows = useMemo(() => {
// //   //   const details = reviewData?.details || [];
// //   //   const paymentCode = reviewData?.master?.CASHACCOUNT || "";
// //   //   return details
// //   //     .filter((d) => {
// //   //       const code = d.code ?? "";
...
// //   // ── Distribution rows only — payment/cash code row excluded, single
// // //     "amount" per row regardless of debit/credit direction.
// // //     Case-agnostic: backend sometimes returns UPPERCASE (raw GLDETAILS)
// // //     and sometimes lowercase (mapped) keys — read both. ─────────────
// // const distributionRows = useMemo(() => {
// //   const details = reviewData?.details || [];
// //   const master = reviewData?.master || {};
// //   const paymentCode = master.CASHACCOUNT ?? master.cashaccount ?? "";

// //   return details
// //     .map((d) => ({
// //       id: d.ID ?? d.id,
// //       code: d.CODE ?? d.code ?? "",
// //       debit: Number(d.DEBIT ?? d.debit ?? 0),
// //       credit: Number(d.CREDIT ?? d.credit ?? 0),
// //       codedescription: d.CODEDESCRIPTION ?? d.codedescription ?? "",
// //       description: d.DESCRIPTION ?? d.description ?? "",
// //     }))
// //     .filter((d) => d.code !== paymentCode && (d.debit > 0 || d.credit > 0))
// //     .map((d) => ({
// //       ...d,
...
// //       ),
// //       cell: ({ row }) => (
// //         <div className=" truncate text-sm text-gray-600" title={row.getValue("DESCRIPTION")}>
// //           {row.getValue("DESCRIPTION")}
// //         </div>
// //       ),
// //     },
...
// //             {/* ── Account Distribution breakdown — code / particular / amount
// //                 only. Payment/cash code row is excluded, and the single
// //                 "amount" is taken from whichever side (debit or credit) it
// //                 actually sits on — so this works for both normal and
// //                 reversed vouchers. ────────────────────────────────────── */}
// //             <div className="px-6 pb-6">
// //               <h3 className="text-[11px] font-semibold uppercase tracking-wide text-slate-500 mb-2">
// //                 Account Distribution
...
// //                     {reviewLoading && (
// //                       <tr>
// //                         <td colSpan={3} className="text-center py-6 text-sm text-slate-400">
// //                           Loading account details…
// //                         </td>
// //                       </tr>
// //                     )}
// //                     {!reviewLoading && distributionRows.length === 0 && (
// //                       <tr>
// //                         <td colSpan={3} className="text-center py-6 text-sm text-slate-400">
// //                           No account rows found.
// //                         </td>
...
// //                           {new Intl.NumberFormat("en-US", { minimumFractionDigits: 2 }).format(
// //                             distributionRows.reduce((s, d) => s + Number(d.amount || 0), 0)
// //                           )}
// //                         </td>
// //                       </tr>
// //                     </tfoot>
...
//                           <TableCell colSpan={4} className="text-right text-sm font-bold text-gray-800">
...
export default function ReceiveTable() {
  ...
  const columns = [
    ...
    },
    {
      id: "attachment",
      header: () => (
        <div className="text-center text-xs font-semibold text-gray-500 uppercase tracking-wide">Invoice Count</div>
      ),
      cell: ({ row }) => (
        <div className="flex justify-center">
          <AttachmentIndicator count={row.original.DOC_COUNT} />
