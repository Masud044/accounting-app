...
//                 Update a manual debit/credit journal entry
//               </p>
//             </div>
...
//                   Existing rows are highlighted — new debit/credit is inline
//                 </p>
//               </div>
//             </div>
...
//                   readOnly
//                   className={`${fieldInput} bg-slate-100 text-slate-500`}
//                 />
//               </div>
//               <div>
//                 <Button
...
//             {/* Rows table — existing rows highlighted, all editable */}
...
//                         row.isExisting ? "bg-indigo-50/40" : i % 2 === 1 ? "bg-slate-50/50" : ""
...
//               <h2 className="text-base font-bold text-gray-900">Confirm Voucher Update</h2>
//             </div>
