        ...
        <SheetHeader className="px-6 py-5 border-b border-border shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <SheetDescription>Add a planned activity for this calendar</SheetDescription>
            </div>
          </div>
        </SheetHeader>
            ...
            <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
              <FormField control={form.control} name="activityName" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Input placeholder="e.g. Vaccination round" disabled={isSubmitting} {...field} /></FormControl>
                  <FormMessage />
                </FormItem>
              )} />
    ...
    <FormMessage />
              ...
              <FormField control={form.control} name="frequency" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Input placeholder="e.g. Monthly" disabled={isSubmitting} {...field} /></FormControl>
                  <FormMessage />
                </FormItem>
              )} />
