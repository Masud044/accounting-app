...
// //   const { data, isLoading, isFetching, isError, error } = useIncomeStatement(applied);
...
// //   const handleApply = () => {
// //     if (!fromDate || !toDate) {
// //       toast.error("From Date  To Date must");
// //       return;
// //     }
...
// //     doc.save(`income-statement_${applied.fromDate}_to_${applied.toDate}.pdf`);
// //   };
...
// //           {error?.message || "Income statement load"}
// //         </p>
// //       ) : null}
...
//   const handleApply = () => {
//     if (!fromDate || !toDate) {
//       toast.error("From Date ও To Date দুটোই দিতে হবে");
//       return;
//     }
//     setApplied({ fromDate, toDate });
//   };
...
//           </div>
//           <div>
//             <h2 className="text-sm font-bold text-gray-900">Income Statement</h2>
...
//           {isError ? (
//             <p className="text-sm text-red-500">
//               {error?.message || "Income statement load করতে সমস্যা হয়েছে"}
//             </p>
//           ) : null}
...
const IncomeStatementReport = () => {
  ...
  const handleExportExcel = () => {
    ...
    XLSX.writeFile(wb, `Income_Statement_${applied.fromDate}_to_${applied.toDate}.xlsx`);
  };
