...
import { useActivities, usePhases, useDeleteActivity } from "./queries";
import AddActivitySheet from "./add-active-sheet";
import UpdateActivitySheet from "./update-active-sheet";
...
export default function ActivitiesTab({ projectId }) {
  ...
  const { data: records = [], isLoading } = useActivities(projectId);
