...
export default function UpdateProjectSheet({ open, onOpenChange, showConfirmation, record }) {
  ...
  useEffect(() => {
    if (open && record) {
      form.reset({
        ...
        durationDesc: record.DURATION_DESC || "",
  ...
  const onSubmit = async (data) => {
    try {
      await updateMutation.mutateAsync({ id: record.PROJECT_ID, data });
