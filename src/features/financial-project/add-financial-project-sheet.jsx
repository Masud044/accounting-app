...
import { useCreateFinancialProjection, useProjects } from "./queries";
...
const defaultValues = { projectId: "", projectionScope: "", revenueAmount: "", operatingCost: "" };

const formatAmount = (val) =>
  Number.isFinite(val) ? val.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : "—";

export default function AddProjectionSheet({ open, onOpenChange, showConfirmation }) {
  const createMutation = useCreateFinancialProjection();
        ...
        <SheetHeader className="px-6 py-5 border-b border-border shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <SheetDescription>Add a revenue/cost projection for a project</SheetDescription>
            </div>
          </div>
        </SheetHeader>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col flex-1 overflow-hidden">
            <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
              ...
              <FormField control={form.control} name="projectionScope" render={({ field }) => (
                <FormItem>
                  <FormLabel>Projection Scope <span className="text-destructive">*</span></FormLabel>
