...
import { useUpdateFinancialProjection, useProjects } from "./queries";
...
export default function UpdateProjectionSheet({ open, onOpenChange, showConfirmation, record }) {
  const updateMutation = useUpdateFinancialProjection();
