...
import { useCreateCowMedicine } from "./queries";
...
export default function AddVaccineSheet({ open, onOpenChange, showConfirmation, cowNo, cowLabel }) {
  const createMutation = useCreateCowMedicine();
  ...
  const onSubmit = async (data) => {
    try {
      ...
      toast.error(err?.message || "Failed to add vaccine record. Please try again.");
    }
  };
      ...
      <SheetContent className="sm:max-w-md w-full flex flex-col gap-0 p-0 z-105">
        ...
        <SheetHeader className="px-6 py-5 border-b border-border shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <SheetTitle>Add Vaccine Record</SheetTitle>
